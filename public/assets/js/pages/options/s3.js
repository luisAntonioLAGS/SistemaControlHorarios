...
=============================================*/
$(document).on("click", ".editarS3", function(){

  var idHorario = $(this).attr("idHorarioS3");
...
formEditarHorarioS3.addEventListener('submit', async (e) => {
  e.preventDefault();

  let datos = new FormData(formEditarHorarioS3);
...
$(document).on("click", ".eliminarS3", function(){
