...
=============================================*/
$(document).on("click", ".editarS2", function(){

  var idHorario = $(this).attr("idHorarioS2");
...
formEditarHorarioS2.addEventListener('submit', async (e) => {
  e.preventDefault();

  let datos = new FormData(formEditarHorarioS2);
...
$(document).on("click", ".eliminarS2", function(){
