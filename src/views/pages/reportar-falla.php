      ...
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header">
            <button class="btn btn-pill btn-success" type="button" data-bs-toggle="modal" data-bs-target="#modalCrearReporte" data-whatever="@getbootstrap" > <i class="icon-plus"></i> Crear Reporte</button>          
          </div>
          <div class="card-body">
            <div>
              <table class="display tablas" id="responsive">
                ...
                <tbody>
                  <?php 
                    ...
                    $idDocente = $admin["id"];
                    $reportes = ControladorReportes::ctrMostrarMisReportes($idDocente);
