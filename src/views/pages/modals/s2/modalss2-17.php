...
<!-- MODAL LUNES 17 -->
<div class="modal fade" id="S2Lunes17" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="post" id="formS2Lunes17">   
...
<!-- MODAL MARTES 17 -->
<div class="modal fade" id="S2Martes17" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title">Agregar Horario</h5>
      ...
      <form method="post" id="formS2Martes17">   
        <div class="modal-body">
          <div class="card-body">
            <div class="row">
              <div class="col-md-12">
...
<!-- MODAL MIERCOLES 17 -->
<div class="modal fade" id="S2Miercoles17" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title">Agregar Horario</h5>
      ...
      <form method="post" id="formS2Miercoles17">   
        <div class="modal-body">
          <div class="card-body">
            <div class="row">
              <div class="col-md-12">
...
<!-- MODAL JUEVES 17 -->
<div class="modal fade" id="S2Jueves17" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title">Agregar Horario</h5>
      ...
      <form method="post" id="formS2Jueves17">   
        <div class="modal-body">
          <div class="card-body">
            <div class="row">
              <div class="col-md-12">
...
<!-- MODAL VIERNES 17 -->
<div class="modal fade" id="S2Viernes17" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title">Agregar Horario</h5>
      ...
      <form method="post" id="formS2Viernes17">   
        <div class="modal-body">
          <div class="card-body">
            <div class="row">
              <div class="col-md-12">
