...
<!-- MODAL LUNES 11 -->
<div class="modal fade" id="S2Lunes11" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="post" id="formS2Lunes11">   
              ...
              <div class="col-md-12">
                  ...
                  <div class="mb-3 m-form__group">
                    ...
                    <div class="input-group"><span class="input-group-text"> <i style="font-size:18px" class="fas fa-clock"></i> </span>
                      <input type="time" class="form-control" name="hora" value="11:00"  autocomplete="off" required readonly>
                    </div>
                  </div>
                  ...
                  <div class="mb-3 m-form__group">
                    ...
                    <div class="input-group"><span class="input-group-text"> <i style="font-size:18px" class="fas fa-clock"></i> </span>
                      <input type="time" class="form-control" name="horas" value="11:30"  autocomplete="off" required readonly>
                    </div>
                  </div>
...
<!-- MODAL MARTES 11 -->
<div class="modal fade" id="S2Martes11" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title">Agregar Horario</h5>
      ...
      <form method="post" id="formS2Martes11">   
        <div class="modal-body">
          <div class="card-body">
            <div class="row">
              <div class="col-md-12">
...
<!-- MODAL MIERCOLES 11 -->
<div class="modal fade" id="S2Miercoles11" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title">Agregar Horario</h5>
      ...
      <form method="post" id="formS2Miercoles11">   
        <div class="modal-body">
          <div class="card-body">
            <div class="row">
              <div class="col-md-12">
...
<!-- MODAL JUEVES 11 -->
<div class="modal fade" id="S2Jueves11" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title">Agregar Horario</h5>
      ...
      <form method="post" id="formS2Jueves11">   
        <div class="modal-body">
          <div class="card-body">
            <div class="row">
              <div class="col-md-12">
...
<!-- MODAL VIERNES 8 -->
<div class="modal fade" id="S2Viernes11" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title">Agregar Horario</h5>
      ...
      <form method="post" id="formS2Viernes11">   
        <div class="modal-body">
          <div class="card-body">
            <div class="row">
              <div class="col-md-12">
