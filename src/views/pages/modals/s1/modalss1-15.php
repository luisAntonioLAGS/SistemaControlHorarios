...
<!-- MODAL LUNES 15 -->
<div class="modal fade" id="S1Lunes15" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="post" id="formS1Lunes15">   
...
<!-- MODAL MARTES 15 -->
<div class="modal fade" id="S1Martes15" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title">Agregar Horario</h5>
      ...
      <form method="post" id="formS1Martes15">   
        <div class="modal-body">
          <div class="card-body">
            <div class="row">
              <div class="col-md-15">
...
<!-- MODAL MIERCOLES 15 -->
<div class="modal fade" id="S1Miercoles15" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title">Agregar Horario</h5>
      ...
      <form method="post" id="formS1Miercoles15">   
        <div class="modal-body">
          <div class="card-body">
            <div class="row">
              <div class="col-md-15">
...
<!-- MODAL JUEVES 15 -->
<div class="modal fade" id="S1Jueves15" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title">Agregar Horario</h5>
      ...
      <form method="post" id="formS1Jueves15">   
        <div class="modal-body">
          <div class="card-body">
            <div class="row">
              <div class="col-md-15">
...
<!-- MODAL VIERNES 15 -->
<div class="modal fade" id="S1Viernes15" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title">Agregar Horario</h5>
      ...
      <form method="post" id="formS1Viernes15">   
        <div class="modal-body">
          <div class="card-body">
            <div class="row">
              <div class="col-md-15">
