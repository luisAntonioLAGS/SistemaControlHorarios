...
<!-- MODAL LUNES 14 -->
<div class="modal fade" id="S1Lunes14" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="post" id="formS1Lunes14">   
...
<!-- MODAL MARTES 14 -->
<div class="modal fade" id="S1Martes14" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title">Agregar Horario</h5>
      ...
      <form method="post" id="formS1Martes14">   
        <div class="modal-body">
          <div class="card-body">
            <div class="row">
              <div class="col-md-14">
...
<!-- MODAL MIERCOLES 14 -->
<div class="modal fade" id="S1Miercoles14" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title">Agregar Horario</h5>
      ...
      <form method="post" id="formS1Miercoles14">   
        <div class="modal-body">
          <div class="card-body">
            <div class="row">
              <div class="col-md-14">
...
<!-- MODAL JUEVES 14 -->
<div class="modal fade" id="S1Jueves14" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title">Agregar Horario</h5>
      ...
      <form method="post" id="formS1Jueves14">   
        <div class="modal-body">
          <div class="card-body">
            <div class="row">
              <div class="col-md-14">
...
<!-- MODAL VIERNES 14 -->
<div class="modal fade" id="S1Viernes14" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title">Agregar Horario</h5>
      ...
      <form method="post" id="formS1Viernes14">   
        <div class="modal-body">
          <div class="card-body">
            <div class="row">
              <div class="col-md-14">
