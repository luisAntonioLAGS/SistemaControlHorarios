...
<!-- MODAL LUNES 17 -->
<div class="modal fade" id="S1Lunes17" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="post" id="formS1Lunes17">   
...
<!-- MODAL MARTES 17 -->
<div class="modal fade" id="S1Martes17" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title">Agregar Horario</h5>
      ...
      <form method="post" id="formS1Martes17">   
        <div class="modal-body">
          <div class="card-body">
            <div class="row">
              <div class="col-md-17">
...
<!-- MODAL MIERCOLES 17 -->
<div class="modal fade" id="S1Miercoles17" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title">Agregar Horario</h5>
      ...
      <form method="post" id="formS1Miercoles17">   
        <div class="modal-body">
          <div class="card-body">
            <div class="row">
              <div class="col-md-17">
...
<!-- MODAL JUEVES 17 -->
<div class="modal fade" id="S1Jueves17" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title">Agregar Horario</h5>
      ...
      <form method="post" id="formS1Jueves17">   
        <div class="modal-body">
          <div class="card-body">
            <div class="row">
              <div class="col-md-17">
...
<!-- MODAL VIERNES 17 -->
<div class="modal fade" id="S1Viernes17" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title">Agregar Horario</h5>
      ...
      <form method="post" id="formS1Viernes17">   
        <div class="modal-body">
          <div class="card-body">
            <div class="row">
              <div class="col-md-17">
