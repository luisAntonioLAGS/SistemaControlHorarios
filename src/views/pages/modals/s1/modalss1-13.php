...
<!-- MODAL LUNES 13 -->
<div class="modal fade" id="S1Lunes13" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="post" id="formS1Lunes13">   
...
<!-- MODAL MARTES 13 -->
<div class="modal fade" id="S1Martes13" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title">Agregar Horario</h5>
      ...
      <form method="post" id="formS1Martes13">   
        <div class="modal-body">
          <div class="card-body">
            <div class="row">
              <div class="col-md-13">
...
<!-- MODAL MIERCOLES 13 -->
<div class="modal fade" id="S1Miercoles13" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title">Agregar Horario</h5>
      ...
      <form method="post" id="formS1Miercoles13">   
        <div class="modal-body">
          <div class="card-body">
            <div class="row">
              <div class="col-md-13">
...
<!-- MODAL JUEVES 13 -->
<div class="modal fade" id="S1Jueves13" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title">Agregar Horario</h5>
      ...
      <form method="post" id="formS1Jueves13">   
        <div class="modal-body">
          <div class="card-body">
            <div class="row">
              <div class="col-md-13">
...
<!-- MODAL VIERNES 13 -->
<div class="modal fade" id="S1Viernes13" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title">Agregar Horario</h5>
      ...
      <form method="post" id="formS1Viernes13">   
        <div class="modal-body">
          <div class="card-body">
            <div class="row">
              <div class="col-md-13">
