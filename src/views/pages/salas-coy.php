                ...
                <tbody>
                  <?php $salas = ControladorSalas::ctrMostrarSalas(null, null);
                    ...
                    $actions = '<div class="btn-group btn-group-pill" role="group">
                      <button class="btn btn-warning editarSala" idSala="'.$value["id"].'" type="button" data-bs-toggle="modal" data-bs-target="#editarSala" data-whatever="@getbootstrap">Editar</button>
            ...
            <div class="row">
              <div class="col-md-12">
                  <div class="mb-3 m-form__group">
                      <label class="form-label">Sala</label>
                      <div class="input-group"><span class="input-group-text"> <i style="font-size:18px" class="fas fa-laptop-house"></i> </span>
                        <input type="text" class="form-control" name="editarSala" placeholder="Nombre de la sala" autocomplete="off" required readonly>
                        <input type="hidden" class="form-control" name="editarId"  autocomplete="off" required>
                      </div>
                  </div>
