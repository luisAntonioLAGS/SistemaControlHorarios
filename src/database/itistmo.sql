...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-10-2022 a las 00:08:16
...
CREATE TABLE `docentes` (
  ...
  `perfil` varchar(60) NOT NULL DEFAULT 'Docente',
...
INSERT INTO `docentes` (`id`, `titulo`, `nombre`, `carrera`, `cedula`, `email`, `usuario`, `password`, `perfil`, `estado`, `cambio_password`) VALUES
(1, 'ING.', 'Aragón Reyes Vera Alexandro', 'Licenciatura como Ingeniero en Sistemas Computacionales', '2063827', '', '', '', 'Docente', 1, 0),
(2, 'ING.', 'Blas Sanchez Mariano', 'Licenciatura como Ingeniero Electronico en Instrumentación', '3094685', '', '', '', 'Docente', 1, 0),
(3, 'ING.', 'Castillejos Gonzalez Jose Manuel', 'Licenciatura en Informatica', '4380034', '', '', '', 'Docente', 1, 0),
(4, 'M.I', 'Castillejos Toledo Maribel', 'Maestria en Informática', '11013822', '', '', '', 'Docente', 1, 0),
(5, 'LIC.', 'Cernas Cruz Amelia Soledad', 'Licenciatura en Informatica', '3295510', '', '', '', 'Docente', 1, 0),
(6, 'M.E', 'Cruz Reyna Maria Janeth', 'Maestria en Educación', '9787641', '', '', '', 'Docente', 1, 0),
(8, 'ING.', 'Cuevas Vadivieso Manuel', 'Licenciatura en Ingenieria en Sistemas Computacionales', '6496127', 'luisenriqueweb@gmail.com', 'lesd', '8a9ef2767c89424b1b614571929ff557', 'Docente', 1, 1);
...
INSERT INTO `horarios` (`id`, `id_materia`, `id_sala`, `id_docente`, `dia`, `hora_inicio`, `hora_fin`) VALUES
(8, 18, 1, 8, 'Lunes', '08:00', '08:30'),
(9, 21, 2, 8, 'Martes', '08:00', '08:30'),
(10, 17, 3, 6, 'Martes', '09:00', '09:30');
...
INSERT INTO `universidad` (`id`, `nombre_universidad`, `email`) VALUES
(1, 'ITISTMO', 'lenrique2015@gmail.com');
